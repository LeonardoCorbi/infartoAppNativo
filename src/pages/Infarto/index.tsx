...
import TabIcons, { Props }from '../../components/TabIcons/index'
  ...
  return (
    <>
      ...
      <View style={styles.tabContainer}>
        ...
        <RectButton activeOpacity={0} rippleColor={'rgba(0,0,0,0)'} style={styles.imc} onPress={handleTouchImc}>
          <Svg width="65" height="65">
            <Circle fill={colors.primary} cx="32.5" cy="32.5" r="32.5"/>
            <Ellipse fill={colors.primary} cx="32.5" cy="30.36" rx="23.88" ry="24"/>
            ...
            <Path fill={"#FFF"} d="M19.83,36.41H17.52V24.31h2.31Z"/>
            <Path fill={"#FFF"} d="M34.23,24.31,36,36.41H33.51l-1-7.9-3.16,7.9H28.18L25,28.49l-1,7.92H21.56l1.72-12.1h2.23l3.21,7.87,3.2-7.87Z"/>
            <Path fill={"#FFF"} d="M43.59,34.39a4,4,0,0,0,3-1.24l.89,2.09a5.65,5.65,0,0,1-1.82,1.07A6.36,6.36,0,0,1,39,34.83a6.23,6.23,0,0,1,0-8.94A6.23,6.23,0,0,1,43.55,24a6.32,6.32,0,0,1,2.11.38,5.45,5.45,0,0,1,1.82,1.06l-.89,2.09a4.14,4.14,0,0,0-3-1.22,4.07,4.07,0,0,0-3,1.18,3.92,3.92,0,0,0,0,5.7A4.07,4.07,0,0,0,43.59,34.39Z"/>
          </Svg>
        </RectButton>
